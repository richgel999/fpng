...
fpng.cpp compared to Wuffs decompression: roughly 10-22% faster decompression (on fpng compressed PNG's - note Wuffs decompression is in general *extremely* fast)
